...
"""Verify that starting browncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start browncoin with -h for help text")
        ...
        self.log.info("Start browncoin with -version for version information")
        ...
        self.log.info("Start browncoind with -fakearg to make sure it does not start")
