...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mBRWN per kB (0.00001 BRWN). This is to prepare for dropping the minimum transaction fee to 0.1 mBRWN per kB (0.0001 BRWN) in the next release.
