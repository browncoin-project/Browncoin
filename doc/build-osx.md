...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Browncoin"

    touch "/Users/${USER}/Library/Application Support/Browncoin/browncoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Browncoin/browncoin.conf"

The first time you run browncoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
