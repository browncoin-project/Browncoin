# Support for Output Descriptors in Browncoin Core

Since Browncoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `brwn1...` for mainnet or `tbrwn1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Browncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Browncoin Core wallets, a convenience function `combo` is
