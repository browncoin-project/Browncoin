...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 20609
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 20610
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 30609
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 30610
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 20609
	%{_sbindir}/semanage port -d -p tcp 20610
	%{_sbindir}/semanage port -d -p tcp 30609
	%{_sbindir}/semanage port -d -p tcp 30610
