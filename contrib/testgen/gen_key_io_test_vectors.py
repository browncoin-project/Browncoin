...
bech32_templates = [
  ...
  ('brwn',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('brwn',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('brwn',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbrwn',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbrwn',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbrwn',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbrwn',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbrwn',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbrwn', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbrwn',  17, 32, False, False, False),
  ('rbrwn',  3,  1, False, False, False),
  ('brwn',   15, 41, False, False, False),
  ('tbrwn',  0, 16, False, False, False),
  ('rbrwn',  0, 32, True,  False, False),
  ('brwn',   0, 16, True,  False, False),
  ('tbrwn',  0, 32, False, True,  False),
  ('rbrwn',  0, 20, False, False, True)
]
