...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.browncoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.browncointools.com");
        vSeeds.emplace_back("dnsseed.browncoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.browncointools.com");
        vSeeds.emplace_back("seed-b.browncoin.loshan.co.uk");
