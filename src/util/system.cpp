...
const char * const BITCOIN_CONF_FILENAME = "browncoin.conf";
...
#else
    const char* pszModule = "browncoin";
#endif
    if (pex)
        return strprintf(
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Browncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Browncoin";
#else
    // Unix
    return pathRet / ".browncoin";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitcoin Core") == std::string::npos) {
        ...
        strYear.replace(strYear.find("2011-2020"), sizeof("2011")-1, "2011-2021");
        strCopyrightHolders += "\n" + strYear + "The Litecoin Core developers";
        strYear.replace(strYear.find("2011-2020"), sizeof("2011-2021")-1, "2009-2021");
