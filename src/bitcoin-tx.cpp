...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " browncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  browncoin-tx [options] <hex-tx> [commands]  Update hex-encoded browncoin transaction\n" +
            "or:     browncoin-tx [options] -create [commands]   Create hex-encoded browncoin transaction\n" +
            "\n";
