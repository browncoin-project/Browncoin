...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s browncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  browncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded browncoin transaction") + "\n" +
              "  browncoin-tx [options] -create [commands]   " + _("Create hex-encoded browncoin transaction") + "\n" +
              "\n";
